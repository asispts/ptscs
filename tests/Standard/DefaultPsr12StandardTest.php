...
final class DefaultPsr12StandardTest extends TestCase
{
    ...
    {
        yield 'ScopeIndent data' => ['ScopeIndent', [
        ...
        yield 'OperatorSpacing data' => ['OperatorSpacing', [
        ...
        yield 'FunctionCallSignature data' => ['FunctionCallSignature', [
        ...
        yield 'concatenation data' => ['concatenation', [
            new ErrorData(3, 'PSR12.Operators.OperatorSpacing.NoSpaceBefore'),
        ]];

        yield 'object data' => ['object', []];

        yield 'ControlStructure data' => ['ControlStructure', [
        ...
        yield 'array data' => ['array', []];
        yield 'language data' => ['language', []];
    }
}
